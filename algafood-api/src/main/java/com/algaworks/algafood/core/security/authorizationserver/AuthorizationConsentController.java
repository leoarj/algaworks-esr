...
/**
 * Controlador para págia personalizada de consentimento (Aprovação de escopos).
 */
@Controller
...
public class AuthorizationConsentController {
	...
	/**
	 * Através dos parâmetros recebidos, busca consentimentos já autorizados
	 * e combina/remove dos consentimentos a autorizar
	 * personaliza valores do modelo (que vão ser processados
	 * na renderização da página de consentimento).
	 */
	...
	public String consent(
		...
		// Busca cliente registrado pelo id recebido
		...
		// Atributos que serão processdos na renderização da tela
