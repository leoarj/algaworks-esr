...
(1, 'João da Silva', 'joao.ger@algafood.com', '$2a$12$RjhIbd6kRGQ2UgykhrIJl.Cva2/yc7ESkZT2jEYtDCtaU83SoykMC', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com', '$2a$12$RjhIbd6kRGQ2UgykhrIJl.Cva2/yc7ESkZT2jEYtDCtaU83SoykMC', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com', '$2a$12$RjhIbd6kRGQ2UgykhrIJl.Cva2/yc7ESkZT2jEYtDCtaU83SoykMC', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@algafood.com', '$2a$12$RjhIbd6kRGQ2UgykhrIJl.Cva2/yc7ESkZT2jEYtDCtaU83SoykMC', utc_timestamp),
(5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2a$12$RjhIbd6kRGQ2UgykhrIJl.Cva2/yc7ESkZT2jEYtDCtaU83SoykMC', utc_timestamp),
(6, 'Débora Mendonça', 'develop.test.leandro+debora@gmail.com', '$2a$12$RjhIbd6kRGQ2UgykhrIJl.Cva2/yc7ESkZT2jEYtDCtaU83SoykMC', utc_timestamp),
(7, 'Carlos Lima', 'develop.test.leandro+carlos@gmail.com', '$2a$12$RjhIbd6kRGQ2UgykhrIJl.Cva2/yc7ESkZT2jEYtDCtaU83SoykMC', utc_timestamp);
...
INSERT INTO `algafood`.`pedido` (`id`, `codigo`, `subtotal`, `taxa_frete`, `valor_total`, `restaurante_id`, `usuario_cliente_id`, `forma_pagamento_id`, `endereco_cidade_id`, `endereco_cep`, `endereco_logradouro`, `endereco_numero`, `endereco_complemento`, `endereco_bairro`, `status`, `data_criacao`) VALUES (1, '89527421-88a0-4d69-a287-9991214176ac', '188.90', '5.00', '193.90', '1', '6', '1', '1', '00000000', 'Rua teste', '100', 'Próximo à praça central', 'Centro', 'CRIADO', utc_timestamp());
...
INSERT INTO `algafood`.`pedido` (`id`, `codigo`, `subtotal`, `taxa_frete`, `valor_total`, `restaurante_id`, `usuario_cliente_id`, `forma_pagamento_id`, `endereco_cidade_id`, `endereco_cep`, `endereco_logradouro`, `endereco_numero`, `endereco_complemento`, `endereco_bairro`, `status`, `data_criacao`) VALUES (2, 'ea4d6733-76b4-4d7f-aa4f-d955214ec531', '87.20', '7.00', '94.20', '4', '6', '2', '2', '11111111', 'Rua teste 2', '200', 'Próximo à torre', 'Centro', 'CRIADO', utc_timestamp());
...
-- Troque a porta das URIs de redirecionamento para 8080 quando for executar pela IDE
INSERT INTO oauth2_registered_client
(id, client_id, client_id_issued_at, client_secret, client_secret_expires_at, client_name, client_authentication_methods, authorization_grant_types, redirect_uris, scopes, client_settings, token_settings)
VALUES('2', 'algafood-web', '2022-11-29 18:58:12', '$2a$10$/Lx1cVKanXiCkpYtdA369OZ78x8aHwx51RTxC.4pqEiuZRzQh0e/i', NULL, 'AlgaFood Web', 'client_secret_basic', 'refresh_token,authorization_code', 'http://127.0.0.1:80/swagger-ui/oauth2-redirect.html,http://127.0.0.1:80/authorized', 'READ,WRITE', '{"@class":"java.util.Collections$UnmodifiableMap","settings.client.require-proof-key":false,"settings.client.require-authorization-consent":true}', '{"@class":"java.util.Collections$UnmodifiableMap","settings.token.reuse-refresh-tokens":false,"settings.token.id-token-signature-algorithm":["org.springframework.security.oauth2.jose.jws.SignatureAlgorithm","RS256"],"settings.token.access-token-time-to-live":["java.time.Duration",900.000000000],"settings.token.access-token-format":{"@class":"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat","value":"self-contained"},"settings.token.refresh-token-time-to-live":["java.time.Duration",86400.000000000],"settings.token.authorization-code-time-to-live":["java.time.Duration",300.000000000]}');
